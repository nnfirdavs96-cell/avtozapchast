...
- **Маркетплейс — Фаза 1.** Готово: продавцы, их товары, модерация, витрина магазина.
  Не сделано: buy-box (одна деталь — предложения нескольких продавцов; сейчас
  `parts.part_number` уникален по всей базе), разбивка заказа по продавцам, кабинет
  заказов продавца, онлайн-оплата, комиссия/выплаты, отзывы о продавцах, возвраты/споры.
...
## 16. Маркетплейс (мультипродавец) — Фаза 1

Цель — площадка, где **сторонние продавцы выкладывают свои товары** (модель Ozon/WB),
в нише автозапчастей. Фаза 1 (фундамент) **завершена**; деньги/заказы — Фазы 2–3.
