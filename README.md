...
- **Маркетплейс** — Фаза 1 (продавцы, товары, модерация) и Фаза 2 (заказы с разбивкой по продавцам, статусы, комиссия) **готовы**; сквозная проверка Фазы 2 на боевом отложена.
...
22. [🏪 Маркетплейс (мультипродавец) — Фазы 1 и 2](#-маркетплейс-мультипродавец--фазы-1-и-2)
...
## 🏪 Маркетплейс (мультипродавец) — Фазы 1 и 2

Площадка, где **сторонние продавцы выкладывают свои товары** (модель Ozon/WB) в нише
автозапчастей. **Фаза 1 (фундамент) и Фаза 2 (заказы по продавцам) завершены.**
...
| 3 | Онлайн-оплата, комиссия, **выплаты** продавцам, балансы | ⬜ (нужен эквайринг в ТJ) |
