...
| [`CHANGES.md`](CHANGES.md) | — | ⚠️ исторический документ одной сессии (июль 2026), **не дополняется** |

**Актуальный статус (август 2026, PR #319):**
...
21. [🏪 Маркетплейс (мультипродавец) — Фаза 1](#-маркетплейс-мультипродавец--фаза-1)
...
**Последние (август 2026) — поиск по поставщику и маркетплейс:**
...
### 📌 Что осталось (по состоянию на 07.2026)
...
| 2 | Заказы: разбивка по продавцам, кабинет заказов продавца, buy-box (одна деталь — много продавцов) | ⬜ |
| 3 | Онлайн-оплата, комиссия, **выплаты** продавцам, балансы | ⬜ (нужен эквайринг в ТJ) |
| 4 | Отзывы о продавцах, возвраты/споры, KYC, аналитика | ⬜ |

> Ограничение Фазы 1: `parts.part_number` **уникален по всей базе**, поэтому один артикул
> пока не может быть у нескольких продавцов — это решается в Фазе 2 (модель «товар ↔ предложения»).
