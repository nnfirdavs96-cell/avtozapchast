...
**Актуальный статус (август 2026, PR #367):**
...
- Сквозная проверка Фазы 2 маркетплейса на боевом (заказ с товарами двух продавцов).
...
- **buy-box** — одна деталь у нескольких продавцов (сейчас `parts.part_number` уникален
  по всей базе). Переход к модели «товар ↔ предложения», этап 2b маркетплейса.
...
| 2b | **buy-box** — одна деталь, много продавцов, выбор лучшего предложения | ⬜ |
| 3b | Онлайн-оплата картой/QR («деньги внутрь») | ⬜ (нужен эквайринг в ТJ) |
| 4 | Отзывы о продавцах, возвраты/споры, KYC, аналитика | ⬜ |

> Оставшееся ограничение: `parts.part_number` **уникален по всей базе**, поэтому один
> артикул пока не может быть у нескольких продавцов. Это и есть buy-box — переход к модели
> «товар ↔ предложения», отдельный этап (2b), в Фазу 2 он не входил.
