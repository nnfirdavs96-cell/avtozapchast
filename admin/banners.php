...
<div class="az-panel">
    ...
    <main class="az-main">
        ...
        <div class="az-content">
                    ...
                    <div class="az-card">
                        ...
                        <div id="imgPreviewWrap" style="margin-bottom:12px;">
                            <?php if ($editBanner && $editBanner['image_url']): ?>
                                <img src="<?= sanitize($editBanner['image_url']) ?>" id="imgPreview"
                        ...
                        <label style="display:inline-flex;align-items:center;gap:8px;padding:9px 16px;background:#f8f9fa;border:2px dashed #ced4da;border-radius:6px;cursor:pointer;font-size:0.875rem;color:#555;">
                            <i class="fa fa-upload"></i> <?= $editBanner ? 'Заменить изображение' : 'Загрузить изображение' ?>
                            <input type="file" id="bannerImg" accept="image/*" style="display:none;" onchange="uploadBannerImg(this)">
                        </label>
            ...
            <script>
            async function uploadBannerImg(input) {
                    ...
                    <div class="az-card" style="padding:0;overflow:hidden;<?= !$banner['is_active'] ? 'opacity:0.55;' : '' ?>">
                        <div style="position:relative;height:160px;background:#f5f5f5;">
                            <?php if ($banner['image_url']): ?>
                                <img src="<?= sanitize($banner['image_url']) ?>" alt=""
