...
function vse_tovary(): array {
    return [
        ...
        [
            ...
            'zakup' => 23000,
            'ostatok' => 3,
            'kategoriya' => 'Двигатель',
        ],
        [
            'id' => 9,
            'nazvanie' => 'Тормозная жидкость DOT4',
            'artikul' => '1987479107',
            'brend' => 'Bosch',
            'zakup' => 2900,
            'ostatok' => 31,
        ...
        <div>
            ...
            <select id="sort" name="sort">
                ...
                <option value="cena_vozr"
                        <?= $sort === 'cena_vozr' ? 'selected' : '' ?>>
                    Сначала дешёвые
                </option>
                <option value="cena_ubyv"
                        <?= $sort === 'cena_ubyv' ? 'selected' : '' ?>>
                    Сначала дорогие
                </option>
                <option value="nazvanie"
                        <?= $sort === 'nazvanie'  ? 'selected' : '' ?>>
                    По названию
                </option>
            </select>
        </div>
