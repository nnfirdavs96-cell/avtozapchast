...
<div style="text-align:center;padding:100px 20px;min-height:60vh;display:flex;flex-direction:column;justify-content:center;align-items:center">
  ...
  <h2 style="font-size:2rem;font-weight:800;color:#222;margin:20px 0 12px">Страница не найдена</h2>
  <p style="color:#888;font-size:1rem;max-width:400px;margin-bottom:30px">Запрашиваемая страница не существует или была перемещена.</p>
