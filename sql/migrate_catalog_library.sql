...
-- Запуск: mysql -u <DB_USER> -p <DB_NAME> < sql/migrate_catalog_library.sql
-- (имя базы передаётся аргументом команды — здесь оно НЕ прописано жёстко,
-- т.к. на разных серверах база называется по-разному, напр. cs360870_auto)
-- ============================================================
